...
Параметры слайдера, будь то шаг, интервал шкалы или диапазон, можно внести изменив соответствующие свойства в объекте *slider*.config и перерендерить слайдер его при помощи вызова метода _render_
